...
public class AlarmService extends JobIntentService {
    ...
    public void onHandleWork(@NonNull Intent intent) {
        Log.e("AlarmService","get intent");
        if (PreferenceManager.getUserName().equals("")) return;
        sendNotification("You got Credits!","You've just receive 100 Free Credits to Unfollow more people!");
...
//        ringtone.play();
        PreferenceManager.restoreFreeCreadit();
        stopSelf();
    }
